...
const ProjectsCard = ({ projectImage, projectNumber, projectTitle, projectLink }) => {
  ...
  return (
    <div className="relative h-[450px] w-[980px] shadow-black transition ease-in-out hover:-translate-y-1 hover:scale-110">
      ...
      <a
        ...
        className="absolute bottom-16 left-10 h-10 w-32 bg-blue-700 flex items-center justify-center transition-transform"
      >
